% Voltage Loop Circuit (Kirchhoff's Voltage Law)
% Demonstrates: TikZ circuits.ee.IEC library with voltage sources and resistors.
...
% --- Circuit loop: 20V source → R (3Ω) → 10V source → R → back ---
